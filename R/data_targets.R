data_targets = list(
  ...
  targets::tar_target(name = vessel_transits, command = get_transits()), 
  targets::tar_target(name = vessel_routes, command = get_routes()), 
  targets::tar_target(name = vessel_grid, command = create_vesselgrid()),
  # targets::tar_target(name = dummy_vessels, command = proxy_vessels()),
  targets::tar_target(name = fishing_layer, command = entgl_surface_risk()),
  targets::tar_target(name = noise_layer_01, command = map_noise(scenario = 1)),
  targets::tar_target(name = noise_layer_02, command = map_noise(scenario = 2)),
  ...
  targets::tar_target(name = scenario_01, command = get_scenarios(scenario = 1)),
  targets::tar_target(name = scenario_02, command = get_scenarios(scenario = 2)),
  targets::tar_target(name = scenario_03, command = get_scenarios(scenario = 3))
