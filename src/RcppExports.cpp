...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type p_mortality(p_mortalitySEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_severity(p_severitySEXP);
    rcpp_result_gen = Rcpp::wrap(entanglement_event(p_entangled, p_head, p_mortality, p_severity));
    return rcpp_result_gen;
END_RCPP
}
// start_mouth
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(increment_cohort(cohort, age, female, bc, min_bc, reprod, abort));
    return rcpp_result_gen;
END_RCPP
}
// feeding_threshold
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(feeding_threshold_vec(min_prey, D));
    return rcpp_result_gen;
END_RCPP
}
// feeding_effort
